function ChatReceived(props) {
    ...
    return (
        <div className='flex ms-8 py-2 justify-start relative left-top w-fit max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl h-auto mt-2 bg-white rounded-xl shadow-sm border-2 border-gray/10'>
