    ...
    return (
        <div className='h-full'>
            <div className='g-6 flex h-full flex-wrap items-center lg:justify-center mx-12 my-8 justify-between   space-x-2'>
                <div className='shrink-1 mb-[12px] mt-[12px] grow-0 basis-auto  md:mb-0 lg:px-20 xl:px-0 md:w-5/12 md:shrink-0 lg:w-8/12 xl:w-7/12'>
                    <img
                ...
                <div className='w-full max-w-xs md:mx-auto mb-[12px] md:mb-0  md:shrink-0 md:w-7/12 lg:w-12/12 xl:w-5/12  ml-2 leading-normal '>
