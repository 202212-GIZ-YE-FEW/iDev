    ...
    return (
        <div className='h-full'>
            <div className='g-6 flex h-full flex-wrap items-center lg:justify-center mx-12 my-8 justify-between   space-x-2'>
                ...
                <div className='w-full max-w-xs  mb-12 md:mb-2 md:w-3/12 lg:w-5/12 xl:w-5/12  ml-2 leading-normal '>
                    ...
                    <form className=' shadow-[0_4px_9px_-4px_#3b71ca] mt-8  p-6'>
                        ...
                        <div className=' flex  lg:text-left  justify-center space-x-5 sm:flex-row'>
                            <Button
                                content='login'
