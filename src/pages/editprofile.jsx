...
function EditProfile({ t }) {
    return (
        <div className='flex flex-wrap'>
            ...
            <div className='container max-w-xl md:shrink-0'>
                <FormTitle title={t("profileInfo")} />
                <div className='flex flex-row justify-center my-5 gap-4'>
                    <Input type='text' name='fullName' label={t("fullName")} />
                </div>
                ...
                <div className='flex flex-row justify-center my-5'>
                    <Input type='text' name='hubbies' label={t("hubbies")} />
                </div>
                ...
                <div className='flex flex-row justify-center my-5'>
                    <Input type='name' name='password' label={t("password")} />
                </div>
                <div className='flex flex-row justify-center my-5'>
                    <Input
                        type='password'
